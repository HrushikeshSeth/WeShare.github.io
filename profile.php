...
<html>
	...
	<head>
		<title>Welcome  To WeShare - Sign up, Log in, Post </title>
...
<?php include ('session.php');?>
	...
	<div id="header">
		<div class="head-view">
			<ul>
				<li><a href="home.php" title="WeShare"><b class="logo">WeShare</b></a></li>
				<li></li>
				<li></li>
				<li></li>
				<li></li>
	...
	<div id="container">
		...
		<div id="left-nav">
				...
				<div class="clip1">
				<a href="updatephoto.php" title="Change Profile Picture"><img src="<?php echo $row['profile_picture'] ?>"><button class="update_btn">Update Picture</button></a>
