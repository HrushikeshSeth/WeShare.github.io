...
<html>
	...
	<head>
		<title>Welcome  To WeShare - Sign-up, Log-in </title>
...
<body>
	...
	<div id="container">
		...
		<center>	
			...
			<h2>Sign up</h2>
			<b class = "required">All fields are required.</b>
		<br />
		...
		<form method="post" action="signup_form.php" enctype="multipart/form-data">
			<table cellpadding="5" cellspacing="5">
				...
				<tr>
					...
					<td><input type="text" name="username2" class="form-1" title="Enter your username" placeholder="Repeat your username....."  required /></td>
				</tr>
				<tr>
					<td colspan="2">Note: Username should be unique.</td>
				</tr>
			</table>
		</fieldset>
		...
		<fieldset class="sign-up-form-1">
			...
			<table cellpadding="5" cellspacing="5">
				...
				<tr>
					...
					<td><input type="text" name="number" placeholder="+91...." maxlength="10" class="form-1" title="Enter your mobile number" required /></td>
				</tr>
			</table>
		</fieldset>
		...
		<fieldset class="sign-up-form-1">
			...
			<table cellpadding="5" cellspacing="5">
				...
				<tr>
					<td colspan="2">Note:Your email address is secured with us.</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2">Note: Choose a strong password.</td>
				</tr>
			</table>
		</fieldset>
		...
		<br />
			...
			<strong>Yes, I have read and I accept the <a href="#">WeShare Terms of Use</a> and the <a href="#">WeShare Privacy Statement</a></strong>
