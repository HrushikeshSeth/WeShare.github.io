...
<html>
	...
	<head>
		<title>Welcome  To WeShare - Sign up, Log in, Chat </title>
...
<body>
	...
	<div id="container">
		<div class="sign-in-form">
			<table>
			<h1 class="logo">Welcome to WeShare</h1>
			<h2>Log in</h2>
	<form method="post" action="signin_form.php" enctype="multipart/form-data">
				...
				<tr>
					...
					<input type="reset" name="cancel" value="Cancel" class="btn-reset" title="Cancel" />
				</tr>
	</form>
			</table>
